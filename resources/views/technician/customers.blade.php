...
<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./"><img src="images/IT_logo.gif" alt="Logo"></a>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Logged Devices</strong>
                        </div>
                        <div class="card-body">
...
<script src="{{asset('js/popper.min.jsjs/popper.min.js')}}"></script>
